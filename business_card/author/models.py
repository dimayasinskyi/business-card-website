...
class CustomerUser(AbstractUser):
    ...
    """
    photo = models.ImageField(upload_to="user/", blank=True, storage=MediaCloudinaryStorage, verbose_name=constants.VERBOSE_PHOTO)
...
class PortFolio(models.Model):
    ...
    photo = models.ImageField(upload_to="portgolio/", blank=True, storage=MediaCloudinaryStorage, verbose_name=constants.VERBOSE_PHOTO)
    created_at = models.DateTimeField(auto_now_add=True, verbose_name=constants.VERBOSE_CREATED_AT)
